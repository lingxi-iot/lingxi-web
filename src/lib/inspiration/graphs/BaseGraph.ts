...
import { AssetInfoPoint, GraphAnchor, GraphType, LinkDrawPoint } from '../common/render'
...
export abstract class BaseGraph {
  ...
  constructor(
    ...
    this.group.on('mouseenter', () => {
      // 显示 连接点
      this.context.linkTool.pointsVisible(true, this.group)
    })
    this.group.on('mouseleave', () => {
      // 隐藏 连接点
      this.context.linkTool.pointsVisible(false, this.group)
      // 隐藏 hover 框
